...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://mahaagro-9eb76.firebaseio.com/"),
    refCart = new Firebase("https://mahaagro-9eb76.firebaseio.com/cart"),
    refUser = new Firebase("https://mahaagro-9eb76.firebaseio.com/users"),
    refCategory = new Firebase("https://mahaagro-9eb76.firebaseio.com/category"),
    refOrder = new Firebase("https://mahaagro-9eb76.firebaseio.com/orders"),
    refFeatured = new Firebase("https://mahaagro-9eb76.firebaseio.com/featured"),
    refMenu = new Firebase("https://mahaagro-9eb76.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
